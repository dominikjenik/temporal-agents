...
# ----- ZBORNIK_APP Use Case Tools -----
developer_zbornik_tool = ToolDefinition(
    name="DeveloperZbornik",
    description="Implement a feature or fix a bug in the ZBORNIK_APP React Native / Expo mobile application (PDF viewer). "
    "Returns a summary of the changes made.",
    arguments=[
        ToolArgument(
            name="feature_description",
            type="string",
            description="Detailed description of the feature or bug fix to implement",
        ),
        ToolArgument(
            name="userConfirmation",
            type="string",
            description="Indication of user's desire to proceed with the implementation",
        ),
    ],
)

devops_zbornik_tool = ToolDefinition(
    name="DevopsZbornik",
    description="Build and deploy the ZBORNIK_APP mobile application by running build_apk.sh and deploy.sh scripts. "
    "Returns the build and deploy status.",
    arguments=[
        ToolArgument(
            name="userConfirmation",
            type="string",
            description="Indication of user's desire to build and deploy the app",
        ),
    ],
)

# ----- GiniDocs Use Case Tools -----
developer_tool = ToolDefinition(
    name="Developer",
    description="Implement a backend (FastAPI/Python) or frontend (React/Next.js) feature in GiniDocs. "
    "Returns a summary of the changes made.",
    arguments=[
        ToolArgument(
            name="feature_description",
        ...
        ToolArgument(
            name="component",
            type="string",
            description="Which part of GiniDocs to modify: 'backend', 'frontend', or 'both'",
        ),
        ToolArgument(
            name="userConfirmation",
            type="string",
...
tester_tool = ToolDefinition(
    name="Tester",
    description="Write and run pytest tests for GiniDocs, then report coverage and results. "
    "Returns test results and coverage summary.",
    arguments=[
        ToolArgument(
            name="test_scope",
            type="string",
            description="Description of what to test — specific module, endpoint, or 'all' for full suite",
        ),
        ToolArgument(
            name="userConfirmation",
            type="string",
            description="Indication of user's desire to run the tests",
        ),
    ],
)
